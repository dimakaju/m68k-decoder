...
{
  public class AnIndirect : Operand
  {
    internal AnIndirect(BinaryReader reader)
      : base(reader)
    {
      Register = reader.ReadInt32();
    }

    internal AnIndirect(int register)
      => Register = register;

    public int Register { get; }

    public override OperandInfo Type => OperandInfo.AnIndirect;
