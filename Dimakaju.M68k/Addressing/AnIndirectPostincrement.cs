...
{
  public class AnIndirectPostincrement : Operand
  {
    internal AnIndirectPostincrement(BinaryReader reader)
      : base(reader)
    {
      Register = reader.ReadInt32();
    }

    internal AnIndirectPostincrement(int register)
      => Register = register;

    public int Register { get; }

    public override OperandInfo Type => OperandInfo.AnIndirectPostincrement;
