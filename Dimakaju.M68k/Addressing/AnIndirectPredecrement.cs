...
{
  internal class AnIndirectPredecrement : Operand
  {
    internal AnIndirectPredecrement(BinaryReader reader)
      : base(reader)
    {
      Register = reader.ReadInt32();
    }

    internal AnIndirectPredecrement(int register)
      => Register = register;

    public int Register { get; }

    public override OperandInfo Type => OperandInfo.AnIndirectPredecrement;
