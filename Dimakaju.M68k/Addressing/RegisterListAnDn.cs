...
{
  public class RegisterListAnDn : RegisterList
  {
    internal RegisterListAnDn(BinaryReader reader)
      : base(reader)
    {
    }

    internal RegisterListAnDn(int mask)
      : base()
    {
      Dn[0] = (mask & 1 << 0) != 0;
      Dn[1] = (mask & 1 << 1) != 0;
    ...
    public override OperandInfo Type => OperandInfo.RegisterListAnDn;
  }
}
