...
{
  internal class Add : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Add;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b1101000_000_000000
      || (data & 0b1111000111000000) == 0b1101000_001_000000
      || (data & 0b1111000111000000) == 0b1101000_010_000000
      || (data & 0b1111000111000000) == 0b1101000_100_000000
      || (data & 0b1111000111000000) == 0b1101000_101_000000
      || (data & 0b1111000111000000) == 0b1101000_110_000000;
