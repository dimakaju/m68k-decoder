...
{
  internal class And : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.And;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b1100000_000_000000
      || (data & 0b1111000111000000) == 0b1100000_001_000000
      || (data & 0b1111000111000000) == 0b1100000_010_000000
      || (data & 0b1111000111000000) == 0b1100000_100_000000
      || (data & 0b1111000111000000) == 0b1100000_101_000000
      || (data & 0b1111000111000000) == 0b1100000_110_000000;
