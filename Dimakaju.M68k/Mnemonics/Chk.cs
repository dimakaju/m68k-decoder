...
{
  internal class Chk : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Chk;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b0100000_10_0000000
      || (data & 0b1111000111000000) == 0b0100000_11_0000000;
