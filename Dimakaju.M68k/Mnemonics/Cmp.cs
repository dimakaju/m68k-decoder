...
{
  internal class Cmp : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Cmp;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b1011000_000_000000
      || (data & 0b1111000111000000) == 0b1011000_001_000000
      || (data & 0b1111000111000000) == 0b1011000_010_000000;
