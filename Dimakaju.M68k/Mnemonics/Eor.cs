...
{
  internal class Eor : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Eor;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b1011000_100_000000
      || (data & 0b1111000111000000) == 0b1011000_101_000000
      || (data & 0b1111000111000000) == 0b1011000_110_000000;
