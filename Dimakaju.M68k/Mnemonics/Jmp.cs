...
{
  internal class Jmp : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Jmp;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111111111000000) == 0b0100111011000000;

    protected override Instruction? TryDecoding(BitStreamReader reader)
    {
      if (reader.Read(10) != 0b0100111011)
        return null;
