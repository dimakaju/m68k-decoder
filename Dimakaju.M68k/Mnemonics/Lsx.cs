...
{
  internal abstract class Lsx : MnemonicDecoder
  {
    public override bool IsRelevant(ushort data)
      => (data & 0b1111000011011000) == 0b11100000_00_001000
      || (data & 0b1111000011011000) == 0b11100000_01_001000
      || (data & 0b1111000011011000) == 0b11100000_10_001000
      || (data & 0b1111111011000000) == 0b11100010_11_000000;
