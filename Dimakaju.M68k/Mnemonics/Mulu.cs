...
{
  internal class Mulu : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Mulu;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b1100000011000000
      || (data & 0b1111111111000000) == 0b0100110000000000;
