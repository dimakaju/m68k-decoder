...
{
  internal class Ori : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Ori;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111111111000000) == 0b00000000_00_000000
      || (data & 0b1111111111000000) == 0b00000000_01_000000
      || (data & 0b1111111111000000) == 0b00000000_10_000000;
