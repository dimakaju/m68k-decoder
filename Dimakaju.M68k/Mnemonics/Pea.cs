...
{
  internal class Pea : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Pea;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111111111000000) == 0b0100100001000000;

    protected override Instruction? TryDecoding(BitStreamReader reader)
    {
      if (reader.Read(10) != 0b0100100001)
        return null;
