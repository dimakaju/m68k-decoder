...
{
  internal abstract class Rox : MnemonicDecoder
  {
    public override bool IsRelevant(ushort data)
      => (data & 0b1111000011011000) == 0b11100000_00_011000
      || (data & 0b1111000011011000) == 0b11100000_01_011000
      || (data & 0b1111000011011000) == 0b11100000_10_011000
      || (data & 0b1111111011000000) == 0b11100110_11_000000;
