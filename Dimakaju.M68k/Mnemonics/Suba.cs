...
{
  internal class Suba : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Suba;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111000111000000) == 0b1001000_011_000000
      || (data & 0b1111000111000000) == 0b1001000_111_000000;
