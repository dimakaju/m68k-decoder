...
{
  internal class Swap : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Swap;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111111111111000) == 0b0100100001000000;

    protected override Instruction? TryDecoding(BitStreamReader reader)
    {
      if (reader.Read(13) != 0b0100100001000)
        return null;
