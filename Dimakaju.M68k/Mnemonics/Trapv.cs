...
{
  internal class Trapv : MnemonicDecoder
  {
    public override MnemonicInfo Type => MnemonicInfo.Trapv;

    public override bool IsRelevant(ushort data)
      => (data & 0b1111111111111111) == 0b0100111001110110;

    protected override Instruction? TryDecoding(BitStreamReader reader)
    {
      if (reader.Read(16) != 0b0100111001110110)
        return null;
